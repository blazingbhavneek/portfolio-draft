...
i18next.use(LanguageDetector).use(initReactI18next).init(
{
    ...
    jp: {
        ...
        昼間はコンピューターを賢くする仕事（プログラミングと機械学習）をしていて、夜は神戸でインド風焼きうどんを作っているかもしれません。  
        インドのスパイスを日本料理に取り入れたり、コードをデバッグしたりしていないときは、カメラを持って街をさまよいながら完璧な一枚を狙っています。  
        元IIT生（IITはインドの最難関で名門の工科大学で、優秀なエンジニアや起業家を輩出しています）で、なぜかAIとフュージョンヌードルを作るために世界の反対側にたどり着きました。  
