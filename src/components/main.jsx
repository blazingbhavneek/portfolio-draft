...
const Main = () => {
  ...
  <div className="flex h-[120vh] w-screen items-center justify-center">
    <div className="grid h-full w-full gap-5 bg-[#fff7eb] p-2 grid-cols-4 grid-rows-5 ">
        ...
        <motion.div className="rounded-3xl col-span-1 row-span-1 bg-[#ff4a1d]  flex items-center justify-center"
        ...
        <motion.div className="rounded-3xl col-span-1 row-span-4 bg-[#1f82fa] flex items-center justify-center"
        initial={{ scale: 0, x: "50%", y: "0%" }}
        animate={{ scale: 1, x: 0, y: 0 }}
        transition={transition}
        >
        ...
        <motion.div className="rounded-3xl col-span-1 row-span-3 bg-black  flex items-center justify-center"
        initial={{ scale: 0, x: "-50%", y: "0%" }}
        animate={{ scale: 1, x: 0, y: 0 }}
        transition={transition}
        >
        ...
        <motion.div className="rounded-3xl col-span-1 row-span-1 bg-[#b9d025]  flex items-center justify-center"
        initial={{ scale: 0, x: "0%", y: "-50%" }}
        animate={{ scale: 1, x: 0, y: 0 }}
        transition={transition}
        >
